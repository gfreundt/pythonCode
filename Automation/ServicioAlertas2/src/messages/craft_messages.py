...
import uuid
from messages import create_within_expiration


def craft(db_cursor, monitor, welcome_recipients, regular_recipients):
    ...
    for IdMember in welcome_recipients:
        messages.append(
            grab_message_info(
                db_cursor,
                IdMember,
    ...
    for IdMember in regular_recipients:
        messages.append(
            grab_message_info(
                db_cursor,
                IdMember,
