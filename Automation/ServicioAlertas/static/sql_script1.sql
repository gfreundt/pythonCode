...
CREATE TABLE tableInfo (
	TableId INTEGER,
	Name TEXT NOT NULL,
	DataRequired INTEGER NOT NULL,
	ScrapeType INTEGER NOT NULL,
	ExpirationUpdate1 DATE,
	ExpirationUpdate2 DATE,
	ExpirationUpdate3 DATE,
	NonExpirationUpdate DATE,
...
DROP TABLE IF EXISTS callaoMultas;
CREATE TABLE callaoMultas (
	Id INTEGER,
...
DROP TABLE IF EXISTS osipteles;
CREATE TABLE osipteles (
	Id INTEGER,
